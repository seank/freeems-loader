...
!define APPNAME "FreeEMS-Loader"
!define COMPANYNAME "FreeEMS"
!define DESCRIPTION "A FreeEMS firmware loading tool."
...
;!define HELPURL "http://powerefi.com/loader" # "Support Information" link
...
#	files "src/images/
	...
	createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\FreeEMS-Loader.exe" "" "$INSTDIR\logo.ico"
...
section "uninstall"
	...
	# Remove files
	delete $INSTDIR\FreeEMS-Loader.exe
